...
public class AddSubView extends LinearLayout {
    ...
    public AddSubView(Context context, AttributeSet attrs) {
        ...
        if(attrs != null){
            ...
            Drawable textBack = tintTypedArray.getDrawable(R.styleable.AddSubView_textBackground);
            if(textBack != null) {
                tvValue.setBackground(textBack);
            }
            int color = tintTypedArray.getColor(R.styleable.AddSubView_valueColor, Color.WHITE);
